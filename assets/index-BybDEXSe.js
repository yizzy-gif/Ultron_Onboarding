...
`,PM=m.span`
  ...
  color: var(--color-content-secondary);
`,ch=240;function zM({open:e,onClose:o,title:i="Run details",usage:s}){const[l,d]=v.useState(()=>s.length?"0":""),[h,f]=v.useState(e),[g,x]=v.useState(!1);if(v.useEffect(()=>{if(e){f(!0);let _=0;const C=requestAnimationFrame(()=>{_=requestAnimationFrame(()=>x(!0))});return()=>{cancelAnimationFrame(C),cancelAnimationFrame(_)}}x(!1);const A=setTimeout(()=>f(!1),ch);return()=>clearTimeout(A)},[e]),!h)return null;const y=s.length,w=`${y} ${y===1?"tool":"tools"} used · tap any to see its query and results`,k=s.map((A,_)=>({entry:A,index:_}));return wi.createPortal(r.jsxs(YM,{role:"dialog","aria-modal":"true","aria-label":i,children:[r.jsx(KM,{$shown:g,onClick:o}),r.jsxs(QM,{$shown:g,children:[r.jsxs(ZM,{children:[r.jsxs(XM,{children:[r.jsx(JM,{children:i}),r.jsx(eN,{children:w})]}),r.jsx(ze,{variant:"ghost",size:"sm",iconOnly:!0,"aria-label":"Close run details",onClick:o,children:r.jsx(pi,{size:18})})]}),r.jsxs(tN,{children:[r.jsx(nN,{"aria-hidden":"true"}),r.jsx(eg,{type:"single",collapsible:!0,value:l,onValueChange:A=>d(typeof A=="string"?A:""),children:k.map(({entry:A,index:_})=>{const C=A.updateData?U0:AM[A.icon];return r.jsx(EM,{value:String(_),label:TM(A),description:A.description,leadingSlot:r.jsx(PM,{"aria-hidden":"true",children:r.jsx(C,{size:18})}),children:r.jsx(rN,{children:r.jsx(OM,{entry:A})})},_)})})]})]})]}),document.body)}function OM({entry:e}){return r.jsxs(r.Fragment,{children:[e.channel&&r.jsxs(pn,{children:[r.jsx(Ut,{children:"Channel"}),r.jsx(om,{children:e.channel})]}),e.message&&r.jsxs(pn,{children:[r.jsx(Ut,{children:"Message"}),r.jsx(tm,{children:e.message})]}),e.recordDetails&&r.jsxs(pn,{children:[r.jsx(Ut,{children:"Record details"}),r.jsx(Pd,{children:e.recordDetails.map((o,i)=>r.jsx(mn,{size:"sm",label:o.label,trailingSlot:r.jsx(zd,{$success:o.emphasis==="success",$placeholder:!o.value,children:o.value||"???"})},i))})]}),e.policies&&r.jsxs(pn,{children:[r.jsx(Ut,{children:`Policies evaluated · ${e.policies.total}`}),r.jsx(gN,{children:e.policies.items.map((o,i)=>r.jsxs(vN,{children:[r.jsx(yN,{"aria-hidden":"true",children:r.jsx(qt,{size:16})}),r.jsx("span",{children:o})]},i))})]}),e.eligible&&r.jsxs(pn,{children:[r.jsx(Ut,{children:`Returned · ${e.eligible.total} ${e.eligible.unit}`}),r.jsx(DM,{candidates:e.eligible.items,total:e.eligible.total,moreNoun:e.eligible.moreNoun})]}),e.threads&&r.jsxs(pn,{children:[r.jsx(Ut,{children:`Threads · ${e.threads.total}`}),r.jsx(qM,{threads:e.threads})]}),e.notification&&r.jsxs(r.Fragment,{children:[r.jsxs(pn,{children:[r.jsx(Ut,{children:"Recipient"}),r.jsx(xN,{children:r.jsx(mn,{size:"md",divider:!1,leadingSlot:r.jsx(Bn,{size:"sm",src:ma(e.notification.seed),name:e.notification.name,alt:"",style:{"--avatar-bg":"var(--color-bg-secondary)"}}),label:e.notification.name,description:e.notification.role,trailingSlot:r.jsx(ze,{variant:"ghost",size:"xs",iconOnly:!0,"aria-label":`Open ${e.notification.name}'s profile`,children:r.jsx(vl,{size:14})})})})]}),r.jsxs(pn,{children:[r.jsx(Ut,{children:"Message"}),r.jsx(tm,{children:e.notification.message})]})]}),e.task&&r.jsxs(pn,{children:[r.jsx(Ut,{children:"Task"}),r.jsx(Pd,{children:e.task.fields.map((o,i)=>r.jsx(mn,{size:"sm",label:o.label,trailingSlot:o.emphasis==="success-tag"?r.jsx(fi,{status:"success",size:"sm",children:o.value}):r.jsx(zd,{$success:o.emphasis==="success",$placeholder:!o.value,children:o.value||"???"})},i))})]}),e.updateData&&r.jsxs(pn,{children:[r.jsx(Ut,{children:"Record details"}),(e.updateData.groups??[e.updateData.fields??[]]).map((o,i)=>r.jsx(Pd,{children:o.map((s,l)=>r.jsx(mn,{size:"sm",label:s.label,trailingSlot:s.emphasis==="change"&&s.previousValue?r.jsxs(FM,{children:[r.jsx(BM,{children:s.previousValue}),r.jsx(WM,{"aria-hidden":"true",children:"→"}),r.jsx(HM,{children:s.value})]}):s.emphasis==="success-tag"?r.jsx(fi,{status:"success",size:"sm",children:s.value}):r.jsx(zd,{$success:s.emphasis==="success",$placeholder:!s.value,children:s.value||"???"})},l))},i))]}),e.recommendation&&r.jsxs(pn,{children:[r.jsx(Ut,{children:"Recommendation"}),r.jsxs(wN,{children:[r.jsxs(nm,{children:[r.jsx(rm,{children:"Incentive?"}),r.jsx(bN,{$add:e.recommendation.add,children:e.recommendation.add?e.recommendation.amount:"No bonus"})]}),r.jsxs(nm,{children:[r.jsx(rm,{children:"Reason"}),r.jsx(kN,{children:e.recommendation.rationale})]})]})]}),e.query&&r.jsxs(pn,{children:[r.jsx(Ut,{children:"Query"}),r.jsx(oN,{children:e.query})]}),e.summary&&r.jsxs(pn,{children:[r.jsx(Ut,{children:"What it does"}),r.jsx(om,{children:e.summary})]})]})}function DM({candidates:e,total:o,moreNoun:i}){var y;const[s,l]=v.useState(!1),d=e.slice(0,3),h=o-d.length,f=parseFloat(((y=d[d.length-1])==null?void 0:y.match)??"4.5"),g=s?Array.from({length:h},(w,k)=>UM(k,f)):[],x=[...d,...g];return r.jsxs(r.Fragment,{children:[r.jsx(dh,{children:x.map((w,k)=>r.jsx(mn,{size:"sm",leadingSlot:r.jsx(Bn,{size:"sm",src:ma(w.name),name:w.name,alt:"",style:{"--avatar-bg":"var(--color-bg-secondary)"}}),label:w.name,trailingSlot:r.jsx(sN,{children:`${w.match} · ${w.distance}`})},k))}),h>0&&r.jsx(d2,{type:"button",onClick:()=>l(w=>!w),"aria-expanded":s,children:s?`Show fewer ${i}`:`+${h} more ${i}`})]})}const dh=m.div`
  border: 1px solid var(--color-border-opaque);
  border-radius: 6px;
...
`,sl=["Lena","Omar","Priya","Devon","Mara","Theo","Nadia","Cole","Ivy","Ravi","Greta","Sam","Yuki","Diego","Hana","Pete","Lola","Kofi"],ll=["Brooks","Nguyen","Shah","Reyes","Ford","Klein","Park","Owens","Diaz","Hale","Mori","Watts","Cruz","Bauer","Singh","Lowe"];function UM(e,o){const i=sl[e%sl.length],s=ll[(e*7+3)%ll.length],l=Math.max(3,o-(e+1)*.1),d=(4+e*13%90/10).toFixed(1);return{name:`${i} ${s}`,match:`${l.toFixed(1)} match`,distance:`${d} mi`}}const em=3;function qM({threads:e}){const[o,i]=v.useState(!1),[s,l]=v.useState(null),d=[...e.items].sort((y,w)=>Jf[y.tone]-Jf[w.tone]),h=Math.max(0,e.total-d.length),f=[...d,...Array.from({length:h},(y,w)=>GM(w))],g=o?f:f.slice(0,em),x=f.length-em;return r.jsxs(r.Fragment,{children:[r.jsx(dh,{children:g.map((y,w)=>{var C;const k=!!((C=y.conversation)!=null&&C.length),A=`${y.name}-${w}`,_=k&&s===A;return r.jsxs(lN,{"data-open":_||void 0,children:[r.jsx(mn,{size:"md",interactive:k,onClick:k?()=>l(_?null:A):void 0,"aria-expanded":k?_:void 0,leadingSlot:r.jsx(Bn,{size:"sm",src:ma(y.seed),name:y.name,alt:"",style:{"--avatar-bg":"var(--color-bg-secondary)"}}),label:y.name,description:y.preview,trailingSlot:r.jsxs(mN,{children:[r.jsx(fi,{status:IM(y),size:"sm",children:y.status}),k?r.jsx(cN,{"data-open":_||void 0,children:r.jsx(Sn,{size:16})}):r.jsx(gn,{size:16})]})}),_&&r.jsx(VM,{messages:y.conversation})]},A)})}),x>0&&r.jsx(d2,{type:"button",onClick:()=>i(y=>!y),"aria-expanded":o,children:o?`Show fewer ${e.moreNoun}`:`+${x} more ${e.moreNoun}`})]})}function VM({messages:e}){return r.jsx(uN,{children:e.map((o,i)=>r.jsxs(hN,{$from:o.from,children:[r.jsx(pN,{children:o.text}),r.jsx(fN,{children:o.time})]},i))})}function GM(e){const o=sl[e%sl.length],i=ll[(e*7+3)%ll.length],s=`${o} ${i}`;return{seed:s,name:s,preview:"Delivered · no reply yet",status:"Delivered",tone:"muted"}}const YM=m.div`
  position: fixed;
  inset: 0;
  z-index: 1000;
  display: flex;
...
`,pn=m.div`
  ...
  flex-direction: column;
  gap: var(--space-2);
`;function oN({children:e}){const[o,i]=v.useState(!1),s=()=>{var l;(l=navigator.clipboard)==null||l.writeText(e),i(!0),window.setTimeout(()=>i(!1),1600)};return r.jsxs(aN,{children:[r.jsx(iN,{children:e}),r.jsx(ze,{variant:"ghost",size:"xs",iconOnly:!0,"aria-label":o?"Copied":"Copy query",onClick:s,children:o?r.jsx(qt,{size:14}):r.jsx(W0,{size:14})})]})}const aN=m.div`
  display: flex;
  align-items: center;
  gap: var(--space-2);
...
`,om=m.div`
  ...
  line-height: var(--line-height-relaxed);
  color: var(--color-content-primary);
`;function _N({milestones:e}){return r.jsx($N,{children:e.map((o,i)=>r.jsx(MN,{milestone:o,last:i===e.length-1},i))})}function u2({milestones:e,typingIndex:o,focusIndex:i,focusBeat:s,collapsed:l,hideActions:d,running:h,animateIn:f,showConnectors:g,reasoning:x}){return r.jsx(CN,{milestones:e,typingIndex:o,focusIndex:i,focusBeat:s,hideActions:d,running:h,defaultCollapsed:l,animateIn:f,showConnectors:g,reasoning:x})}function CN({milestones:e,typingIndex:o,focusIndex:i,focusBeat:s,hideActions:l,running:d,animateIn:h=!0,showConnectors:f=!0,defaultCollapsed:g=!1,reasoning:x=!1}){const[y,w]=v.useState(!1),_=g||x&&!d?e.length:0,C=_>0,N=C&&!y?_:0,$=e.slice(0,_).map(j=>j.headline).join(" · "),S=e.length>0&&N>=e.length;return r.jsx(IN,{$animate:h,children:r.jsxs(PN,{$compact:S,children:[C&&!y&&r.jsx(sm,{$tight:!0,$last:S,$connected:f,children:r.jsxs(f2,{type:"button","aria-expanded":y,onClick:()=>w(j=>!j),children:[r.jsx(dm,{"aria-hidden":"true",children:r.jsx(tl,{size:16})}),r.jsx(KN,{children:$})]})}),e.slice(N).map((j,O)=>{var F,Y;const R=N+O,M=d&&typeof i=="number"&&R>i,T=d&&typeof i=="number"&&R===i,z=M?"plan":T?"working":"done",B=!d||typeof i!="number"||R<i-1?"done":R===i-1?"working":"upcoming",G=!!((F=j.progress)!=null&&F.length),Z=R===e.length-1;return r.jsxs(sm,{$tight:!G,$last:Z,$connected:f,children:[f&&!Z&&B!=="upcoming"&&r.jsx(ON,{"aria-hidden":"true",$state:B,$tight:!G,$superseded:g}),r.jsx(p2,{milestone:j,label:LM(j.headline,z),last:!0,collapsible:!0,placeholder:M,focused:T,startOpen:!d&&y,onCollapse:C&&y&&!T?()=>w(!1):void 0,progressBeat:T?s:void 0,superseded:g,typing:R===o,extra:!M&&((Y=j.usage)!=null&&Y.length)?r.jsx(SN,{usage:j.usage,title:j.headline}):void 0,icon:x&&!d&&!M?r.jsx(dm,{"aria-hidden":"true",children:r.jsx(tl,{size:16})}):r.jsx(h2,{icon:j.icon,loading:o===R||T||d&&typeof i!="number"&&R===e.length-1,placeholder:M,muted:g})})]},R)}),!l&&!d&&r.jsx(Xo,{time:Yn(e)})]})})}const am=["Thinking","Bridging","Reinforcing","Inspecting","Crossing"];function jN(){const[e,o]=v.useState(0);return v.useEffect(()=>{if(e>=am.length-1)return;const i=setTimeout(()=>o(s=>s+1),3200);return()=>clearTimeout(i)},[e]),r.jsxs(r.Fragment,{children:[am[e],r.jsxs(EN,{"aria-hidden":"true",children:[r.jsx("span",{children:"."}),r.jsx("span",{children:"."}),r.jsx("span",{children:"."})]})]})}function Yn(e){const i=581+e.reduce((f,g)=>f+g.headline.length,0)%200,s=Math.floor(i/60)%24,l=i%60,d=s<12?"AM":"PM";return`${s%12===0?12:s%12}:${String(l).padStart(2,"0")} ${d}`}function Xo({time:e}){const[o,i]=v.useState(null),s=l=>i(d=>d===l?null:l);return r.jsx(DN,{"data-feedback-actions":!0,children:r.jsxs(_0,{visibility:"always",time:e,children:[r.jsx(lm,{variant:"ghost",size:"xs",iconOnly:!0,"aria-label":"Good response","aria-pressed":o==="up","data-active":o==="up"||void 0,onClick:()=>s("up"),children:r.jsx(F0,{size:14})}),r.jsx(lm,{variant:"ghost",size:"xs",iconOnly:!0,"aria-label":"Bad response","aria-pressed":o==="down","data-active":o==="down"||void 0,onClick:()=>s("down"),children:r.jsx(B0,{size:14})}),r.jsx(ze,{variant:"ghost",size:"xs",iconOnly:!0,"aria-label":"Rerun",children:r.jsx(ki,{size:14})})]})})}function SN({usage:e,title:o}){const[i,s]=v.useState(!1);return v.useEffect(()=>{if(!i)return;const l=d=>{d.key==="Escape"&&s(!1)};return window.addEventListener("keydown",l),()=>window.removeEventListener("keydown",l)},[i]),e.length?r.jsxs(FN,{children:[r.jsxs(ze,{variant:"tertiary",size:"xs",trailingArtwork:r.jsx(gn,{size:12}),"aria-haspopup":"dialog","aria-expanded":i,onClick:()=>s(!0),children:[e.length," ",e.length===1?"tool":"tools"," used"]}),r.jsx(zM,{open:i,onClose:()=>s(!1),title:o,usage:e})]}):null}function MN({milestone:e,last:o}){return r.jsxs(qN,{children:[r.jsxs(VN,{children:[r.jsx(h2,{icon:e.icon}),!o&&r.jsx(XN,{})]}),r.jsx(p2,{milestone:e,last:o})]})}function NN({records:e,initial:o=3}){const[i,s]=v.useState(!1),l=i?e:e.slice(0,o),d=e.length-o;return r.jsxs(fR,{children:[l.map((h,f)=>r.jsx(c2,{record:h},f)),d>0&&r.jsx(mR,{type:"button",onClick:()=>s(h=>!h),children:i?"Show less":`Show ${d} more`})]})}function h2({slotRef:e,hidden:o,loading:i,placeholder:s,muted:l}){return s?r.jsx(cm,{ref:e,"aria-hidden":"true",$hidden:o,$placeholder:!0,children:r.jsx(YN,{})}):r.jsx(cm,{ref:e,"aria-hidden":"true",$hidden:o,$loading:i,children:r.jsxs(ZN,{viewBox:"0 0 24 24",$loading:i,$muted:l&&!i,children:[r.jsx("circle",{className:"ring",cx:"12",cy:"12",r:"9"}),r.jsx("path",{className:"check",d:"M7.5 12.4l3 3 6-6.4"})]})})}function p2({milestone:e,label:o,last:i,typing:s,icon:l,collapsible:d=!0,extra:h,placeholder:f,focused:g,progressBeat:x,superseded:y,startOpen:w,onCollapse:k}){var Z,F,Y;const A=o??e.headline;if(f)return r.jsx(hm,{$last:i,$dim:!0,children:r.jsxs(vi,{as:"div",children:[l,r.jsx(pm,{children:A})]})});const _=!!((Z=e.blocks)!=null&&Z.length),C=!!h,N=!d||!!e.defaultOpen||!!w,[$,S]=v.useState(null),j=!!k,O=j?!0:$??N,R=d&&(_||C),M=!j&&R&&(!s||!!g),T=M&&!!g&&!!((F=e.progress)!=null&&F.length),z=()=>S(()=>!O),B=_&&(j||!d||O),G=C&&(j||!d||O);return r.jsxs(hm,{$last:i,children:[r.jsxs(vi,{as:j||R?"button":"div",type:j||R?"button":void 0,$interactive:j||M,"aria-expanded":j?!0:M?O:void 0,onClick:j?k:M?z:void 0,children:[l,r.jsx(pm,{$focused:!!g,children:A}),M&&!g&&r.jsx(JN,{"data-open":O||void 0,"aria-hidden":"true",children:r.jsx(gn,{size:14})})]}),(Y=e.progress)!=null&&Y.length?r.jsx(nR,{$indent:!!l,children:r.jsxs(eR,{children:[T&&r.jsx(tR,{type:"button","aria-expanded":O,"aria-label":O?"Hide details":"Show details",onClick:z,children:O?r.jsx(Vu,{size:16}):r.jsx(vo,{size:16})}),r.jsx(LN,{steps:e.progress,avatars:e.avatars,avatarsOnSettle:e.avatarsOnSettle,reached:e.reached,live:!!(s||g),beat:x,superseded:y,showAvatars:O||s||g})]})}):null,B&&r.jsx(dR,{$indent:!!l,children:e.blocks.map((ee,ae)=>r.jsxs(uR,{children:[ee.text&&r.jsx(hR,{children:s?r.jsx(uh,{text:ee.text}):ee.text}),ee.label&&r.jsx(pR,{children:ee.label}),ee.bullets&&r.jsx(gR,{children:ee.bullets.map((re,oe)=>r.jsx("li",{children:re},oe))}),ee.checks&&r.jsx(vR,{children:ee.checks.map((re,oe)=>r.jsxs("li",{children:[r.jsx(yR,{"aria-hidden":"true"}),r.jsx("span",{children:re})]},oe))}),ee.records&&r.jsx(NN,{records:ee.records})]},ae))}),G&&r.jsx(BN,{$indent:!!l,children:h})]})}const RN=1350;function LN({steps:e,avatars:o,avatarsOnSettle:i,reached:s,live:l,showAvatars:d,beat:h,superseded:f}){const g=e.length-1,x=typeof h=="number",[y,w]=v.useState(l?0:g),k=v.useRef(l);v.useEffect(()=>{l&&!k.current&&(k.current=!0,w(0))},[l]),v.useEffect(()=>{if(x||!k.current||y>=g)return;const N=setTimeout(()=>w($=>Math.min($+1,g)),RN);return()=>clearTimeout(N)},[y,g,x]),v.useEffect(()=>{typeof h=="number"&&w(Math.min(h,g))},[h,g]);const A=typeof h=="number"?Math.min(h,g):y,_=A>=g,C=_&&!l;return r.jsxs(rR,{children:[r.jsx(aR,{$done:C,$live:l,$superseded:f,"aria-live":"polite",children:l?r.jsx(uh,{text:e[A],caret:!1,speed:26}):e[A]},A),d&&(i?_:_||l)&&(o!=null&&o.length)?r.jsx(AN,{seeds:o,total:s}):null]})}const im=90;function AN({seeds:e,total:o,max:i=5}){const s=e.slice(0,i),l=Math.max(o??0,e.length),d=l-s.length;return r.jsxs(iR,{"aria-label":`${l} people reached`,children:[s.map((h,f)=>r.jsx(sR,{style:{zIndex:s.length-f,animationDelay:`${f*im}ms`},children:r.jsx(Bn,{size:"sm",src:ma(h),name:h,alt:""})},h)),d>0&&r.jsxs(lR,{"aria-hidden":"true",style:{animationDelay:`${s.length*im}ms`},children:["+",d]})]})}const $N=m.div`
  display: flex;
  flex-direction: column;
  font-family: var(--font-sans);
`,TN=Se`
...
`,ON=m.span`
  ...
  ${e=>e.$state==="working"?Ye`
        ...
        animation: ${zN} 1.25s linear infinite;
      `:e.$state==="upcoming"?Ye`
        width: 0;
...
`,HN=m.span`
  ...
  animation: ${e=>e.$blink?WN:"none"} 1s step-end infinite;
...
`,YN=m.span`
  ...
  animation: ${GN} 1.6s ease-in-out infinite;
...
`,um=56.5,ZN=m.svg`
  ...
  .ring {
    ...
    animation: ${QN} 2s linear infinite;
...
`,ph=m.div`
  ...
  animation: ${N2} var(--duration-slow) var(--ease-out);
...
`,RL=m.span`
  font-size: var(--text-sm);
  color: var(--color-content-secondary);
  animation: ${NL} 1.1s ease-in-out infinite;
...
`;const EL={"Coverage Recovery":Ir,"Fill Optimization":Ir,Recruiting:Ir,Users:Ir,Attendance:fn,"Attendance Recovery":fn,"Time Off":fn,Scheduling:fn,Compliance:ua,Onboarding:lo,"Payroll Operations":O0,Invoicing:zr,Reporting:bf,"Marketplace Optimization":bf,Engagement:nl,"Autonomous Operations":fl},PL=e=>EL[e]??fl,wm=["Monitoring 142 active shifts","Scanning for coverage risks","Analyzing attendance trends","Optimizing open orders"],zL=2800,OL=200,DL=6,FL=2200,di=520;function BL({onDetectRisk:e,deckActive:o=!1,deck:i}){const[s,l]=v.useState(0),d=v.useRef(e);d.current=e;const h=v.useRef(new Set),[f,g]=v.useState(!1),x=v.useRef(null);v.useEffect(()=>{const R=setInterval(()=>l(M=>(M+1)%wm.length),zL);return()=>clearInterval(R)},[]);const y=Math.min(DL,Bs.length),[w,k]=v.useState([]),A=v.useRef(0),_=v.useRef(Bs.filter(R=>!R.risk)),C=v.useRef(Bs.filter(R=>R.risk)),N=v.useRef({routine:0,risk:0,sinceRisk:0,gap:0}),$=()=>5+Math.floor(Math.random()*5),S=()=>{const R=N.current,M=C.current;if(M.length>0&&R.sinceRisk>=R.gap)return R.sinceRisk=0,R.gap=$(),M[R.risk++%M.length];R.sinceRisk+=1;const T=_.current;return T.length>0?T[R.routine++%T.length]:M[R.risk++%M.length]},j=R=>R.risk?"risk":Math.random()<.28?"action":"none",O=v.useRef(null);return v.useEffect(()=>{if(Bs.length===0){k([]);return}if(o)return;N.current={routine:0,risk:0,sinceRisk:0,gap:$()},A.current=0;const R=Array.from({length:y},()=>{const z=S();return{key:A.current++,event:z,phase:"in",outcome:j(z),resolved:!0}});if(R.length>0){const z=R[R.length-1];z.resolved=!1,O.current={key:z.key,event:z.event,outcome:z.outcome}}else O.current=null;k(R);const M=[],T=setInterval(()=>{var F;const z=S(),B=A.current++,G=j(z),Z=O.current;Z&&Z.outcome==="risk"&&(g(!0),x.current&&clearTimeout(x.current),x.current=setTimeout(()=>g(!1),2800),h.current.has(Z.event.id)||(h.current.add(Z.event.id),(F=d.current)==null||F.call(d,Z.event))),O.current={key:B,event:z,outcome:G},k(Y=>{const ee=Y.filter(oe=>oe.phase!=="leaving"),ae=ee.length>=y?ee[0].key:null;return[...Y.map(oe=>oe.key===ae?{...oe,phase:"leaving"}:Z&&oe.key===Z.key&&!oe.resolved?{...oe,resolved:!0}:oe),{key:B,event:z,phase:"entering",outcome:G,resolved:!1}]}),M.push(setTimeout(()=>{k(Y=>Y.map(ee=>ee.key===B?{...ee,phase:"in"}:ee))},40)),M.push(setTimeout(()=>{k(Y=>Y.filter(ee=>ee.phase!=="leaving"))},di))},FL);return()=>{clearInterval(T),M.forEach(clearTimeout),x.current&&clearTimeout(x.current)}},[y,o]),r.jsxs(WL,{children:[r.jsxs(HL,{children:[r.jsx(UL,{children:r.jsx(vt,{mark:"circle",size:OL,tone:"auto",state:"active",coreGradient:f,"aria-label":"Ultron"})}),r.jsx(qL,{children:"Ultron"}),r.jsx(VL,{role:"status","aria-live":"polite",children:r.jsxs(YL,{children:[r.jsx(KL,{children:wm[s]}),r.jsxs(QL,{"aria-hidden":"true",children:[r.jsx("span",{children:"."}),r.jsx("span",{children:"."}),r.jsx("span",{children:"."})]})]},s)})]}),o?r.jsx(XL,{children:i},"deck"):w.length>0&&r.jsx(ZL,{"aria-label":"Live event feed",children:w.map(R=>{const M=PL(R.event.capability);return r.jsx(JL,{"data-phase":R.phase,"aria-hidden":R.phase==="leaving"||void 0,children:r.jsx(eA,{children:r.jsxs(tA,{"data-outcome":R.resolved?R.outcome:"pending",children:[r.jsxs(nA,{children:[r.jsx(rA,{"aria-hidden":"true",children:r.jsx(M,{size:16})}),r.jsxs(oA,{children:[r.jsx(cA,{children:R.event.capability}),r.jsx(dA,{children:R.event.title})]})]}),r.jsx(aA,{children:R.resolved?R.outcome==="risk"?r.jsxs(r.Fragment,{children:[r.jsx(vt,{mark:"pulse",size:20,tone:"auto",state:"active",color:"var(--color-orange-content-tertiary)",coreHalo:!1,"aria-hidden":"true"}),r.jsx(iA,{children:"Risk detected"})]}):R.outcome==="action"?r.jsxs(r.Fragment,{children:[r.jsx(vt,{mark:"pulse",size:20,tone:"auto",state:"active",color:"var(--color-blue-content-primary, var(--color-slate-content-secondary))",coreHalo:!1,"aria-hidden":"true"}),r.jsx(lA,{children:"Action required"})]}):r.jsx(sA,{children:"No action needed"}):r.jsx(vt,{mark:"magnetic2d",size:20,tone:"auto",state:"active","aria-label":"Analyzing"})})]})})},R.key)})},"feed")]})}const WL=m.div`
  flex: 1;
  min-height: 0;
  overflow: hidden;
  display: flex;
...
`,uA=5e3,hA=5,Zs=320,pA=e=>e.status==="needs_approval"||e.status==="recommended";function fA({threads:e,stageById:o,onAction:i,onRefinement:s,onSaveWorkflow:l,onToggleSaveWorkflow:d,pendingWorkflowIds:h,savedWorkflowIds:f,onReveal:g,onClose:x}){const[y]=v.useState(()=>e.filter(pA).map((M,T)=>({t:M,index:T})).sort((M,T)=>la[M.t.severity]-la[T.t.severity]||M.index-T.index).slice(0,hA).map(({t:M})=>M.id)),[w,k]=v.useState(1),[A,_]=v.useState(new Set),[C,N]=v.useState(new Set),$=v.useRef(new Map);v.useEffect(()=>{if(w>=y.length)return;const M=setTimeout(()=>k(T=>T+1),uA);return()=>clearTimeout(M)},[w,y.length]),v.useEffect(()=>{const M=T=>{T.key==="Escape"&&x()};return window.addEventListener("keydown",M),()=>window.removeEventListener("keydown",M)},[x]),v.useEffect(()=>{const M=$.current;return()=>{M.forEach(T=>clearTimeout(T))}},[]);const S=y.findIndex(M=>!A.has(M));v.useEffect(()=>{if(y.length>0&&S===-1){const M=setTimeout(x,260);return()=>clearTimeout(M)}},[S,y.length,x]);const j=Math.max(w,S+1);v.useEffect(()=>{y.slice(0,j).forEach(M=>g==null?void 0:g(M))},[j]);const O=(M,T)=>{N(B=>new Set(B).add(M.id));const z=setTimeout(()=>{N(B=>{const G=new Set(B);return G.delete(M.id),G}),_(B=>new Set(B).add(M.id)),$.current.delete(M.id),i(M.id,T)},Zs);$.current.set(M.id,z)},R=y.length-A.size;return r.jsxs(mA,{role:"region","aria-label":"New cases",children:[r.jsxs(vA,{children:[r.jsx(Ut,{children:"Needs your decision"}),r.jsx(da,{children:R}),r.jsx(yA,{}),r.jsx(ze,{variant:"ghost",size:"xs",iconOnly:!0,"aria-label":"Dismiss (Esc)",onClick:x,children:r.jsx(pi,{size:16})})]}),r.jsx(gA,{children:r.jsx(xA,{children:y.slice(0,j).map((M,T)=>{if(A.has(M))return null;const z=e.find(B=>B.id===M);return z?r.jsx(bA,{"data-exiting":C.has(M)||void 0,children:r.jsx(_R,{thread:z,stage:o[M]??0,expanded:T===S,onAction:(B,G)=>O(z,G),onRefinement:s,onSaveWorkflow:l,onToggleSaveWorkflow:d,saveIntent:h.includes(M),saved:f.includes(M)})},M):null})})})]})}const mA=m.div`
  display: flex;
  flex-direction: column;
  gap: var(--space-4);
  flex: 1;
...
`,km=m.div`
  ...
  ${e=>!e.$static&&!e.$closing&&Ye`
    animation: ${MA} 280ms var(--ease-out, cubic-bezier(0.4, 0, 0.2, 1)) both;
  `}
...
`,M$=m.div`
  ...
  color: var(--color-content-tertiary);
  max-width: 360px;
`,Mm=72,Nm=.58;function jn(e){const o=Math.sin(e*127.1+311.7)*43758.5453;return o-Math.floor(o)}function Rm(e,o,i,s){const l=getComputedStyle(o).getPropertyValue(i).trim();if(!l)return s;e.fillStyle="#000",e.fillStyle=l;const d=e.fillStyle;if(d.startsWith("#")){const f=d.slice(1),g=parseInt(f.length===3?f.split("").map(x=>x+x).join(""):f,16);return(g>>16&255)+","+(g>>8&255)+","+(g&255)}const h=d.match(/[\d.]+/g);return h&&h.length>=3?`${+h[0]},${+h[1]},${+h[2]}`:s}const N$=e=>{const[o,i,s]=e.split(",").map(Number);return(.299*o+.587*i+.114*s)/255};function D2({links:e=0}){const o=v.useRef(null),i=v.useRef(0),s=v.useRef(e);return s.current=Math.max(0,Math.min(1,e)),v.useEffect(()=>{const l=o.current;if(!l)return;const d=l.getContext("2d");if(!d)return;const h=Math.min(2,window.devicePixelRatio||1);let f=0,g=0;const x=()=>{f=l.clientWidth,g=l.clientHeight,l.width=Math.max(2,Math.round(f*h)),l.height=Math.max(2,Math.round(g*h)),d.setTransform(h,0,0,h,0,0)};x();const y=new ResizeObserver(x);y.observe(l);const w=Rm(d,l,"--color-bg-primary","255,255,255"),k=N$(w)<.5,A=Rm(d,l,"--color-content-tertiary",k?"148,163,184":"71,85,105"),_=Array.from({length:Mm},(R,M)=>{const T=M%3===0,z=T?1-.5*Math.pow(jn(M*3.1),1.6):jn(M*3.1),B=T?.5*Math.pow(jn(M*5.7),1.6):jn(M*5.7);return{bx:z,by:B,vx:(jn(M*7.3)-.5)*.008,vy:(jn(M*9.9)-.5)*.008,wA:6+jn(M*4.7)*10,wS:.25+jn(M*6.1)*.5,wP:jn(M*8.2)*6.2832,r:.8+jn(M*2.3)*1.6,twS:.8+jn(M)*1.4,twP:jn(M*11.4)*6.2832}}),C=(R,M)=>{const T=((R.bx+R.vx*M)%1+1)%1,z=((R.by+R.vy*M)%1+1)%1,B=T-.5,G=Math.abs(B)*2,Z=G<1e-4?1:(Nm+(1-Nm)*G)/G;return{x:(.5+B*Z)*f+Math.cos(M*R.wS+R.wP)*R.wA,y:z*g+Math.sin(M*R.wS*.8+R.wP)*R.wA}},N=(()=>{try{return window.matchMedia("(prefers-reduced-motion: reduce)").matches}catch{return!1}})(),$=R=>{i.current+=(s.current-i.current)*.04,Math.abs(i.current-s.current)<.001&&(i.current=s.current),d.clearRect(0,0,f,g);const M=_.map(T=>C(T,R));for(let T=0;T<Mm;T++){const z=_[T],B=.35+.65*(.5+.5*Math.sin(R*z.twS+z.twP)),G=.82+i.current*.18;d.fillStyle="rgba("+A+","+B*G*(k?.55:.42)+")",d.beginPath(),d.arc(M[T].x,M[T].y,z.r*(.7+.3*B),0,6.2832),d.fill()}};if(N)return i.current=s.current,$(1.15),()=>y.disconnect();$(1.15);let S=0;const j=performance.now(),O=R=>{$(1.15+(R-j)/1e3),S=requestAnimationFrame(O)};return S=requestAnimationFrame(O),()=>{cancelAnimationFrame(S),y.disconnect()}},[]),r.jsx(R$,{"aria-hidden":"true",children:r.jsx("canvas",{ref:o})})}const R$=m.div`
  position: absolute;
  inset: 0;
  overflow: hidden;
  pointer-events: none;
...
`,NP=m.aside`
  ...
  animation: ${MP} 240ms cubic-bezier(0.22, 0.61, 0.36, 1);
  padding-top: env(safe-area-inset-top);
  padding-bottom: env(safe-area-inset-bottom);
`,RP=m.div`
  display: flex;
...
`;function uD(){const{theme:e,toggle:o}=cD(),i=e==="dark",s=i?"Switch to light mode":"Switch to dark mode";return r.jsx(dD,{type:"button",onClick:o,"aria-label":s,"aria-pressed":i,title:s,children:i?r.jsx(N0,{size:18}):r.jsx(V0,{size:18})})}const c0=[{id:"ultron",label:"Ultron",icon:r.jsx(vt,{mark:"circle",size:32,tone:"auto",state:"idle","aria-label":"Ultron"})},{id:"home",label:"Home",icon:r.jsx(qS,{})},{id:"engaged",label:"Engaged",icon:r.jsx(VS,{}),hasUnread:!0},{id:"inbox",label:"Inbox",icon:r.jsx(GS,{}),hasUnread:!0},{id:"invoice",label:"Invoice",icon:r.jsx(YS,{})},{id:"ai-home",label:"AI Home",icon:r.jsx(KS,{})}],d0=[{id:"apps",label:"Apps",icon:r.jsx(QS,{})}],u0=[{id:"docs",label:"Document Studio",icon:r.jsx(bu,{})},{id:"form",label:"Form",icon:r.jsx(ZS,{})},{id:"tasks",label:"Tasks",icon:r.jsx(XS,{})},{id:"policy",label:"Policy",icon:r.jsx(JS,{}),activeIcon:r.jsx("img",{src:FP,width:16,height:16,style:{display:"block"},alt:""})},{id:"automation",label:"Automation",icon:r.jsx(go,{}),activeIcon:r.jsx("img",{src:BP,width:16,height:16,style:{display:"block"},alt:""})},{id:"payroll",label:"Payroll",icon:r.jsx(eM,{})},{id:"esign",label:"E-Sign Studio",icon:r.jsx(tM,{})}],hD=m.button`
  display: block;
  width: 100%;
  margin-bottom: var(--space-2);
